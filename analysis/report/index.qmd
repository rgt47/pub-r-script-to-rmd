...
description: "I did not really know how to quickly convert a working R script into a presentable report until I discovered knitr::spin() and a few supporting workflows that changed how I share analytical results."
...
described in [A Workflow Construct for the Modern Data Scientist](../wf-construct-overview-anchor/). The
Document layer holds the artifact a reader sees, a rendered
...
![A wrinkled hand-annotated draft half-tucked under a clean, freshly bound report: a rough draft becoming a formal document.](media/images/ambiance1.jpg){.img-fluid height=3.5in}
...
![A carpenter's plane shaving a rough wooden board
smooth: smoothing a rough draft into a polished
report](media/images/ambiance2.jpg){.img-fluid height=3.5in}
...
report](media/images/ambiance3.png){.img-fluid height=3.5in}
...
2. **Rapid Conversion of Draft R Scripts to Formal Rmd** (this post)
